...
public class EventFormDB {
    ...
    public EventFormDB(int id_user,String pic_event,String name_organizer, String tel, String name_event, String name_producer, String date_reg_start, String date_reg_end, String objective, String detail){
