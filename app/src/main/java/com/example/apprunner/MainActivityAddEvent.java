...
public class MainActivityAddEvent extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (validateAddevent(id_user,organizer ,tel, event, producer, date_start, date_end, objective, detail)) {
                    doAddevent(id_user ,editorganizer , edittel ,editevent ,editproducer ,textdatestart ,textdateend ,editobjective ,editdetail);
                }
            }

            private boolean validateAddevent(int id_user,String organizer,String tel , String event, String producer, String date_start, String date_end , String objective, String detail) {
            ...
            private void doAddevent(int id_user, EditText editorganizer, EditText edittel, final EditText editevent, final EditText editproducer, TextView textdatestart, TextView textdateend, EditText editobjective, EditText editdetail) {
                uploadImage(id_user, editorganizer, edittel, editevent, editproducer, textdatestart, textdateend, editobjective, editdetail);
            }
        });
    ...
    private void uploadImage(final int id_user, final EditText editorganizer, final EditText edittel, final EditText editevent, final EditText editproducer, final TextView textdatestart, final TextView textdateend, final EditText editobjective, final EditText editdetail) {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            downloadUri.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    add_event(id_user, photoStringLink, editorganizer, edittel, editevent, editproducer, textdatestart, textdateend, editobjective, editdetail);
                                }
                            });
                        }
                    })
    ...
    public void add_event(int id_user, String photoStringLink, EditText editorganizer, EditText edittel, final EditText editevent, final EditText editproducer, TextView textdatestart, TextView textdateend, EditText editobjective, EditText editdetail){
        MainActivity mainActivity = new MainActivity();
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(mainActivity.url)
                .addConverterFactory(GsonConverterFactory.create())
